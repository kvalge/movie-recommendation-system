    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CastAndCrewCountry", x => new { x.CastAndCrewsId, x.CountriesId });
                    table.ForeignKey(
                        name: "FK_CastAndCrewCountry_CastAndCrews_CastAndCrewsId",
                        column: x => x.CastAndCrewsId,
                        principalTable: "CastAndCrews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CastAndCrewCountry_Countries_CountriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CastAndCrewMovie", x => new { x.CastAndCrewsId, x.MoviesId });
                    table.ForeignKey(
                        name: "FK_CastAndCrewMovie_CastAndCrews_CastAndCrewsId",
                        column: x => x.CastAndCrewsId,
                        principalTable: "CastAndCrews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CastAndCrewMovie_Movies_MoviesId",
                        column: x => x.MoviesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CastAndCrewCountry_CountriesId",
                table: "CastAndCrewCountry",
                column: "CountriesId");

            migrationBuilder.CreateIndex(
                name: "IX_CastAndCrewMovie_MoviesId",
